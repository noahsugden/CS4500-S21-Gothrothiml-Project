...
public class client {
    ...
    public static String command = "{\"command\":\"roads\", \n" +
            "  \"params\" : [ {\"from\" : String, \"to\" : String } ] }";

    public static void placeCharacter(JSONObject single) throws JSONException {
        String characterName = single.getString("character");
        String townName = single.getString("town");
    ...
    public static void main(String[] argv) throws  JSONException {
        ...
        String roadsInput = sc.nextLine();
        JSONTokener jsonToken = new JSONTokener(roadsInput);
        ...
        String characterInput = sc.nextLine();
